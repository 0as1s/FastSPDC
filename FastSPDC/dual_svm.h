...
public:
	...
	void fit_FastSPDCs(Data& train_data);
	void fit_FastSPDC(Data& train_data);
	...
	double calculate_dual_FastSPDC(Data& train_data)const;////calculate dual value for FastSPDC only
